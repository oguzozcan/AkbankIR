...
public abstract class BaseActivity extends AppCompatActivity implements BaseFragment.OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NavDrawerListAdapter adapter = new NavDrawerListAdapter(this, menuItems, imageId, getSubMenuItems(), !ItemListActivity.isLocaleTurkish(lang));
...
//                            }else{
//                                Toast.makeText(BaseActivity.this.getBaseContext(), "Bu döküman sadece ingilizcede mevcut", Toast.LENGTH_SHORT).show();
//                            }
